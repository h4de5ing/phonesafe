...
public class SplashActivity extends Activity {
    ...
    private static final String appServicesAddress = "http://www.19code.com";  //版本更新检测服务器地址
    ...
    private void checkVersion() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                Log.i(TAG, "网络地址：appServicesAddress" + appServicesAddress);
                OkHttpClientManager.getAsyn(appServicesAddress + "/app.json", new OkHttpClientManager.ResultCallback<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (Servicesersion > localVersion) {
